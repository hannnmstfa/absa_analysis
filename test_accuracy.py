...
print(f"NB F1 Score: {models.get('f1_nb', 0)*100:.1f}%")
print(f"SVM F1 Score: {models.get('f1_svm', 0)*100:.1f}%")
print(f"Best Model F1 Score: {models.get('akurasi_model', 0)*100:.1f}%")
print(f"Evaluation: {models.get('evaluation_source_label', '-')}")
print(f"Modeling rows: {models.get('modeling_rows', 0)}")
